...
const ErrorHandlisng = ({props}) => {
  return (
    <div
      class="container relative flex items-center px-4 py-3 text-sm font-bold text-white bg-blue-500 mt-5 w-[55rem]"
      role="alert"
    >
      <svg
        width="20"
