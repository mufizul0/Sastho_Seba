          ...
          <table className="w-full whitespace-nowrap">
            <thead>
              <tr className="h-16 w-full text-sm leading-none text-gray-800">
                ...
                <th className="font-normal text-left pl-20">Car Number</th>
              </tr>
            </thead>
...
export default AmbulenceManagement;

const TableRow = ({ props }) => {
    console.log(props);
  const [show, setShow] = useState(null);
  const handleDelete = (id, email) => {
    axios.delete(`https://api-sastho-seba.onrender.com/am/usr/data/${id}`);
  ...
  return (
    <>
      <tr className="h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
        ...
        <td className="pl-20">
                  <p className="font-medium">{props.cont_no},{ props.car_p_no}</p>
        </td>
