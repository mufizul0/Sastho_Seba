...
export const AddNewStore = () => {
    ...
    const sendDataToServer = (data) => {
      axios.post("https://api-sastho-seba.onrender.com/str/usr/data", data);
  };
      ...
      registerUser(data.name, data.mail, data.pass)
        .then((userCredential) => {
          ...
          updateProfile(auth.currentUser, {
            ...
            saveUser(data.mail, data.name, "store");
            logout();
          });
        })
        .catch((error) => {});
                ...
                <div>
                  ...
                  <div class="md:flex items-center lg:ml-24 mt-8">
                    ...
                    <div class="md:w-64 md:ml-12 md:mt-0 mt-4">
                      ...
                      <input
                        {...register("store_cont", { required: true })}
                        type="name"
                        tabindex="0"
                        class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800"
                        aria-labelledby=""
                ...
                <div>
                  <div class="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                    <div class="md:w-64">
                      ...
                      <input
                        {...register("store_loc", { required: true })}
                        type="name"
                        tabindex="0"
                        class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800"
                        aria-labelledby=""
                    ...
                    <div class="md:w-64 md:ml-12 md:mt-0 mt-4">
                      ...
                      <input
                        {...register("ad_info", { required: false })}
                        type="name"
                        tabindex="0"
                        class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800"
